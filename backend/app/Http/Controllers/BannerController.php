    ...
    public function index(Request $request)
    {
        ...
        $banners = $query->get()->map(function ($banner) use ($locale) {
            return [
                ...
                'image_url' => $banner->image_url ? (str_starts_with($banner->image_url, 'http') ? $banner->image_url : url($banner->image_url)) : null,
                'mobile_image_url' => $banner->mobile_image_url ? (str_starts_with($banner->mobile_image_url, 'http') ? $banner->mobile_image_url : url($banner->mobile_image_url)) : null,
