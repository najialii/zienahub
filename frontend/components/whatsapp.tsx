const WhatsAppFloatingButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-primary text-white rounded-full  hover:bg-[#128C7E] hover:scale-110 transition-all duration-300 group"
      aria-label="Chat on WhatsApp"
    >
      <span className="absolute right-16 scale-0 group-hover:scale-100 transition-transform bg-gray-900 text-white text-xs font-medium py-2 px-3 rounded-xl shadow-xl whitespace-nowrap">
        Chat with us!
      </span>
