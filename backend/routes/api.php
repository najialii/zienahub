...
Route::get('/tenants', [App\Http\Controllers\TenantController::class, 'index']); // Handles ?featured=1
Route::get('/tenants/{idOrSlug}', [App\Http\Controllers\TenantController::class, 'show']);
Route::get('/tenants/{tenant}/products', [App\Http\Controllers\TenantController::class, 'products']);